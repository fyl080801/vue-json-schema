  ...
  <div id="example-six" class="container mb-3 mt-3">
    ...
    <form @submit="onSubmit" novalidate>
      ...
      <transition name="fade" mode="out-in">
        ...
        <div v-if="submitted && !success && state.vjsErrors.length > 0" class="alert alert-danger" key="has-errors">
          Form has errors, please fix and resubmit!
        </div>
        <div v-if="submitted && !success && state.vjsErrors.length === 0" class="alert alert-success" key="has-no-errors">
